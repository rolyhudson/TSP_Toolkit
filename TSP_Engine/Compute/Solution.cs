    ...
    public static partial class Compute
    {
        ...
        public static Result Solution(Parameters parameters, bool runSolarAnalysis)
        {
            ...
            if (runSolarAnalysis)
            {
                ...
                parameters.SolarAccessParameters.Obstructions.AddRange(units);

                solarResults = SolarAnalysis(option.Item1, parameters.SolarAccessParameters.SunPoints, parameters.SolarAccessParameters.Obstructions);
            }
